...
/**
 * Accepts an existing friend requests, 
 * from the specified user to a logged in user.
 */
public class AcceptFriendRequestHandler  implements BaseHandler  {
    @Override
    public HttpResponseBuilder handleRequest(ParsedRequest request) {
        ...
        checkAccepted.put("isAccepted", true);
        ...
        newDocument.put("isAccepted", true);
        newDocument.put("isDenied", false);
